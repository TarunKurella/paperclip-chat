  ...
  return (
    ...
    >
      ...
      {props.suggestions.length > 0 ? (
        <div className="mt-3 rounded-2xl border border-stone-200 bg-white p-2">
          ...
          <div className="space-y-1">
            {props.suggestions.map((candidate) => (
              <button
                ...
                className="flex w-full items-center justify-between rounded-xl px-3 py-2 text-left transition hover:bg-stone-50"
              >
